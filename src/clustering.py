...
for file_name in os.listdir(folder_path):
    if file_name.endswith("pearson-estimate.csv"):
        ...
        try:
            correlation_value = data.loc['prima.donnas', 'density']
        except KeyError:
...
output_file = 'C:/Universita/Magistrale/EQS/Community_Smell_project/data_dir_pearson_SNA/prima_donnas_density.csv'
